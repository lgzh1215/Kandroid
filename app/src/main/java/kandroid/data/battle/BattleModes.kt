...
sealed class BattleModes(val flag: Int) {
    ...
    object BaseAirRaid :        BattleModes(0b1000000)       // 深海抄家

    object Practice :           BattleModes(0b10000000)      // 演習

    object CombinedUndefined :  BattleModes(0b100000000)     // 連合艦隊
    object CombinedTaskForce :  BattleModes(0b1000000000)    // 機動部隊
    object CombinedSurface :    BattleModes(0b10000000000)   // 水上部隊

    object EnemyCombinedFleet : BattleModes(0b100000000000)  // 敵連合艦隊
