...
class MasterShipData : JsonWrapper(), Identifiable {
    ...
    val remodelAfterShip: MasterShipData? get() = KCDatabase.Master.ship[remodelAfterShipId]
    var remodelBeforeShipId: Int = 0
    val remodelBeforeShip: MasterShipData? get() = KCDatabase.Master.ship[remodelBeforeShipId]
